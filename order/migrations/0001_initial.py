    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recurrence_frequency', models.CharField(
                    choices=[('none', 'Keine Wiederholung'), ('daily', 'Täglich'), ('weekly', 'Wöchentlich'),
                             ('biweekly', 'Alle zwei Wochen'), ('monthly', 'Monatlich'),
                             ('quarterly', 'Vierteljährlich'), ('semiannual', 'Halbjährlich'), ('annual', 'Jährlich')],
                    default='none', max_length=20, verbose_name='Häufigkeit')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(
                    choices=[('draft', 'Entwurf'), ('pending', 'Wartend auf Genehmigung'), ('approved', 'Genehmigt'),
                             ('sent', 'Bestellt'), ('partially_received', 'Teilweise erhalten'),
                             ('received', 'Vollständig erhalten'), ('received_with_issues', 'Erhalten mit Mängeln'),
                             ('cancelled', 'Storniert')], default='draft', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_type', models.CharField(
                    choices=[('note', 'Note'), ('status_change', 'Status Change'), ('system', 'System Notification')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'Active'), ('canceled', 'Canceled'),
                                                     ('partially_canceled', 'Partially Canceled')], default='active',
                                            max_length=20)),
                ...
                ('defective_quantity', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('supplier_sku', models.CharField(blank=True, max_length=100)),
                ('item_notes', models.TextField(blank=True)),
                ('tax_rate', models.DecimalField(decimal_places=2, default=0,
                                                 help_text='Der zum Zeitpunkt der Bestellung gültige Mehrwertsteuersatz',
                                                 max_digits=5, verbose_name='MwSt-Satz')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Bezeichnung für diese Teillieferung', max_length=100,
                                          verbose_name='Bezeichnung')),
                ('expected_delivery', models.DateField(blank=True, null=True, verbose_name='Erwarteter Liefertermin')),
                ('status', models.CharField(
                    choices=[('planned', 'Geplant'), ('in_transit', 'In Transit'), ('received', 'Erhalten'),
                             ('cancelled', 'Storniert')], default='planned', max_length=20, verbose_name='Status')),
                ...
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL,
                                                 related_name='created_order_splits', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Menge')),
                ('order_split', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items',
                                                  to='order.ordersplit')),
            ],
            options={
